...
protected:
    String mBaseName;
    bool mIsGLSL;
    GpuProgramPtr generateVertexShader(MaterialGenerator::Perm permutation) override;
    GpuProgramPtr generateFragmentShader(MaterialGenerator::Perm permutation) override;
    MaterialPtr generateTemplateMaterial(MaterialGenerator::Perm permutation) override;
