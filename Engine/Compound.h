...
{    
    ...
    const static String type_names[10] = {
        "Null",
        "String",
        "Char",
        "Short"
...
#pragma region Binary data
        ...
        explicit operator T&()
        {
            if (type != Type::BinaryData || sizeof(T) != binary_type_size) throw new TypeMismatchException(Type::BinaryData, type, sizeof(T), binary_type_size);
            return *(T*)data;
        }
