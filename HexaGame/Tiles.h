...
#define INIT_COMPLEX_TILE_DATABASE_ENTRY(name, type, resources_path_root, mesh_name, ...) INIT_DATABASE_ENTRY(name, type, Mesh::load_obj(resources_path_root##_MESHES_TILES + mesh_name + ".obj"), Texture::load_png(resources_path_root##_TEXTURES_COMPLEXTILES + #name + ".png"), __VA_ARGS__);
...
public:
    ...
    DATABASE_INIT_FUNC(TileInfo)
    {
        ...
        INIT_SOLID_TILE_DATABASE_ENTRY(grass, GrassInfo, RESOURCES_HEXA, true, true);
        ...
        INIT_COMPLEX_TILE_DATABASE_ENTRY(tall_grass, TallGrassInfo, RESOURCES_HEXA, "tall_grass", HexaGame::foliage_material);
        INIT_COMPLEX_TILE_DATABASE_ENTRY(blue_roses, TallGrassInfo, RESOURCES_HEXA, "tall_grass", HexaGame::foliage_material);
        INIT_COMPLEX_TILE_DATABASE_ENTRY(red_roses, TallGrassInfo, RESOURCES_HEXA, "tall_grass", HexaGame::foliage_material);
        INIT_COMPLEX_TILE_DATABASE_ENTRY(chamomile, TallGrassInfo, RESOURCES_HEXA, "tall_grass", HexaGame::foliage_material);

        INIT_COMPLEX_TILE_DATABASE_ENTRY(ash_stem, TreeStemInfo, RESOURCES_HEXA, "tree_stem", Game::get_basic_material_3d(),
