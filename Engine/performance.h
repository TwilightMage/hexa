...
FORCEINLINE void measure_time_all_impl(List<std::chrono::duration<long long, std::ratio<1, 10000000>>>& intervals, TimePointTypes... time_points)
{
...
#define measure_time_all(name, ...) List<std::chrono::duration<long long, std::ratio<1, 10000000>>> name; measure_time_all_impl(name, __VA_ARGS__);
